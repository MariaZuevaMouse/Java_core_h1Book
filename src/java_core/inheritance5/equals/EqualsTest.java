package java_core.inheritance5.equals;

import java_core.inheritance5.test1.Employee;
import java_core.inheritance5.test1.Manager;
...
public class EqualsTest {
    public static void main(String[] args) {
        ...
        Manager carl = new Manager("Carl Cracker", 80000, 1897,12,15);
        Manager boss = new Manager("Carl Cracker", 80000, 1897,12,15);
